...
<%@ page import="com.iesemilidarder.projectzero.web.ShowRestaurantsServlet" %>
...
<main role="main">
    ...
    <div class="container">
        ...
        <%
            ...
            ArrayList rl = readDB.readRestaurantes(request.getParameter("buscar"));
...
<footer class="container">
    <p>&copy; Tomás Sastre Cámara 2017</p>
</footer>
